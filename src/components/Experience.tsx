  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-40 h-40 bg-green-500/5 rounded-full blur-3xl animate-pulse delay-1000" />
      ...
      {isLargeScreen ? (
        <>
          <div className="absolute left-1/2 w-1 h-full bg-gradient-to-b from-blue-500 via-green-500 to-blue-500 transform -translate-x-1/2 shadow-lg shadow-blue-500/25" />
        ...
        <>
          <div className="absolute left-8 w-1 h-full bg-gradient-to-b from-blue-500 via-green-500 to-blue-500 shadow-lg shadow-blue-500/25" />
