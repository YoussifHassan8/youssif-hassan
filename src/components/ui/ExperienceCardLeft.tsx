  ...
  return (
    <div className="relative experience-card animate-slide-in-left">
      <div
        className={`absolute ${
          !small ? "left-1/2" : ""
        } -translate-x-1/2 bg-gradient-to-br from-blue-500 to-green-500 border-4 border-white/20 rounded-full p-3 z-10 shadow-lg shadow-blue-500/25 transition-all duration-300 timeline-dot animate-timeline-glow`}
      >
