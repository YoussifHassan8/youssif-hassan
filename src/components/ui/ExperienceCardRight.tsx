...
const ExperienceCardRight = ({
  ...
  return (
    <div className="relative experience-card animate-slide-in-right">
      ...
      <div className="relative bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-sm border border-gray-700/50 p-6 w-[380px] ml-[120px] rounded-2xl shadow-xl transition-all duration-300 card-content animate-card-float hover:shadow-2xl hover:shadow-blue-500/10 hover:scale-[1.02]">
        <div className="absolute right-[-22px] top-[6px] text-blue-500 drop-shadow-lg">
